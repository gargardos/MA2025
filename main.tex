...
Die Ansprüche an Schulbildung und an politische Bildung sind seit jeher Bestandteil reger Diskurse. Verschieden Einflüsse und eine Welt, die sich rapide verändert, schaffen eine herausfordernde Lage. In der Unterrichtspraxis stehen Lehrkräfte hingegen vor alltäglichen Entscheidungen und Aufgaben. Eine davon ist die Auswahl von Themen und die Vorbereitung von Material. 
...
\begin{itemize}
    ...
    \item \dots wie die Metaebene um das eigentliche Unterrichtsmaterial herum den Erfolg und die Verbreitung von Unterrichtsmaterial
    ...
    \item \dots wie die Qaulität des Unterrichtsmaterials, welches bei der \acrlong{ank} veröffentlicht werden soll, bewertet werden könnte. Das schließt eine Überprüfung auf mögliche Fehler und Ungenauigkeiten, sowie das Anschneiden von möglichen Alternativen ein. beeinflusst. 
\end{itemize}
...
Zusammengefasst hat Wehling drei konsensuale Punkte herausgearbeit:
\begin{enumerate}
...
BREEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
...
Zielgruppenorientierung ist idealerweise über die gesamte Unterrichtsvorbereitung und entsprechend im Unterrichtsmaterial mitzudenken. 
Gerade Materialvorschläge, die zur Verbreitung gedacht sind und nicht mit einer einzelnen Kohorte im Blick entwickelt wurden, können Vorschläge zur Staffelung beinhalten. Die Zielgruppe kann dann aber sinvollerweise nur nach \enquote{hardfacts} wie Altersspanne, wahrscheinliche Lernorte und Fortschritt im Bildungssystem (Jahrgang \gls{etc}) adressiert werden. 
...
\emph{M4} gibt in einem kleinen Kasten Informationen zur Erhebung der Daten an. Sozusagebn ein überblicksweiser Methodenteil. Aufgrund der Vorbildfunktion kann man die Quelle daher gut nutzen. Schade ist wiederrum, dass zu den erwähnten Modellprojekten auf \gls{S} 6 keine Quellen angegeben sind. Erneut gilt, die \gls{ank} produziert in weiten Teilen gutes Material mit hoher Transparenz (so sind auch in \emph{M4} Verantwortliche und Mitarbeitende angegeben). Aber bei dem konsequenten Angeben von Quellen ist auch dort noch Verbesserungspotential. 
