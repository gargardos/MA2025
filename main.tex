...
\textsc{Aufgabe 2} a) \quad
Hinweis: Das Interview ist in M1, auch wenn in der Aufgabe M2 steht. 
Das Interview wird aber sozusagen in der Präsentation (M2) zusammengefasst. Die Hauptaussagen von M1 und M2 sind: 
\begin{myitemize}
...
\paragraph{Arbeitsleben A1 -- \enquote{Was ist Einkommensarmut und wie kann sie erklärt werden? Welche Leistungen kann ich in Bremen beantragen, wenn ich von Einkommensarmut betroffen bin?}}




\paragraph{Erwartungshorizont: Arbeitsleben A2} (\gls{S} \pageref{ARBEITSLEBEN-A2})

\paragraph{Arbeitsleben A2 -- \enquote{Wie viel verdienen Arbeitnehmer:innen in Bremen und welche (politischen und wirtschaftlichen) Maßnahmen würden die Situation am Arbeitsmarkt verbessern?}}


\paragraph{Erwartungshorizont: Arbeitsleben A3} (\gls{S} \pageref{ARBEITSLEBEN-A1})

\paragraph{Arbeitsleben A3 -- \enquote{Welche Aufgaben haben Gewerkschaften und wie ist der Interessenausgleich von Arbeitnehmer:innen und Arbeitgeber:innen (gesetzlich) organisiert?}}
...
\paragraph{Erwartungshorizont: Arbeitsleben B 1} (\gls{S} \pageref{ARBEITSLEBEN-B1})

\paragraph{Arbeitsleben B1 -- \enquote{Welche gesetzlichen Grundlagen regulieren die Arbeitszeiten und wie kann ich mich vor entgrenzter Arbeit schützen?}}



\paragraph{Erwartungshorizont: Arbeitsleben B2} (\gls{S} \pageref{ARBEITSLEBEN-B2})

\paragraph{Arbeitsleben B2 -- \enquote{Welche gesetzlichen Grundlagen regulieren die Arbeitszeiten und wie kann ich mich vor entgrenzter Arbeit schützen?}}



\paragraph{Erwartungshorizont: Arbeitsleben B3} (\gls{S} \pageref{ARBEITSLEBEN-B3})

\paragraph{Arbeitsleben B3 -- \enquote{Welche gesetzlichen Grundlagen regulieren die Arbeitszeiten und wie kann ich mich vor entgrenzter Arbeit schützen?}}
...
\paragraph{Erwartungshorizont: Arbeitsleben C1}

\paragraph{Arbeitsleben C1 -- \enquote{Welche Aufgaben haben Gewerkschaften und wie ist der Interessenausgleich von Arbeitnehmer:innen und Arbeitgeber:innen (gesetzlich) organisiert?}}  (\gls{S} \pageref{ARBEITSLEBEN-C1})



\paragraph{Erwartungshorizont: Arbeitsleben C2}

\paragraph{Arbeitsleben C2 -- \enquote{Politik meets Betrieb: Wie kann betriebliche Mitbestimmung die Demokratie stärken?}}  (\gls{S} \pageref{ARBEITSLEBEN-C2})
