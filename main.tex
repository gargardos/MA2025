...
Die \gls{kmk} definiert Lehrmittel als Materialen der Schule und Lernmittel als Materialien der Schüler*innen \autocite{KMKMittel}. Gerade im Hinblick auf Verbrauchsmaterial und dessen Finanzierung bestimmt eine sinnvolle Unterscheidungsdimension. Papier und Stifte, stammen in der Regel von Schüler*innen, die abbrechende Bohrerspitze im Werkunterricht und % die Objektträger zur Mikroskopie 
...
Der Bildungsplan selbst ist von fiskalisch finanzierten Stellen erarbeitet und für einen Bildungsbereich veröffentlicht, welcher sich vermutlich auch als öffentlich versteht -- sowohl in Form von öffentlichen Geldern finanziert als auch in Form von öffentlich zugänglich -- da es sich um einen verbreiteten, staatlich vorgezeichneten \mbox{(Weiter-)Bildungsweg} % \mbox trennt Begriff nicht 
...
\end{itemize}
\citeyear{weißeno.2010} veröffentlichten Georg Weißeno, Joachim Detjen, Ingo Juchler, Peter Massing und Dagmar Richter \citetitle[\emph{Ein Kompetenzmodell}]{weißeno.2010}. Das darin vorgebrachte Kompentenzmodell % (\gls{s} \gls{abb} \ref{2010kompMod}: \gls{S} \pageref{2010kompMod}) 
...
Es wird das Material zu den drei Themenfeldern \emph{Demokratie} (\gls{S} \pageref{DEMOKRATIE}), \emph{Arbeitsleben} (\gls{S} \pageref{ARBEITSLEBEN}) und \emph{Wirtschaftspolitik} (\gls{S} \pageref{WIRTSCHAFTSPOLITIK}) untersucht. \\
...
% Eine präzisere Ausdifferenzierung wird in diesem Material dann nicht über eine angepasste Kompentenzformulierung erreicht, sondern über das ausformulierte Thema und die Leitfragen gewährleistet.
...
\subsubsection{Operationalisiete Arbeitsaufträge}
...
Der Einführungstext stellt mehrere Daten dar, ohne diese weiter zu belegen.
...
In der Angabe ist dankbarerweise ein Datum angegeben, welches jedoch leider irreführend ist. Das angepsrochene Gesetz, kurz auch Arbeitsschutzgesetz (ArbschSchG), ist 1996 erlassen worden\footnote{Stand 18.06.2025 ist folgendes die aktuelle Version: \enquote{Arbeitsschutzgesetz vom 7. August 1996 (BGBl. I S. 1246), das zuletzt durch Artikel 32 des Gesetzes vom 15. Juli 2024 (BGBl. 2024 I Nr. 236) geändert worden ist}.}. Die betreffende Änderung ist ebenfalls nicht 2021, sondern noch rechtzeitig 2020 erlassen worden. Das Inkraftreten der maßgeblichen Änderung für die im Text angesprochenen \enquote{Mindestbesichtigungsquote} ist durch eine Ergänzung in Absatz 1 und das Anfügen von Absatz 1a in §21 % \footnote{
...
Zu 2021 wurde das Arbeitsschutzgesetz\footnote{
    ...
    Bis 2026 sollen mindestens 5\% aller Betriebe abgedeckt sein (ArbschSchG §21 (1a))($\rightarrow$ Bundesgesetze). 
\end{quote}
...
\paragraph{Demokratie A1 Einstieg: \enquote{Welche Erfahrungen mit Arbeitsschutz habt ihr bisher gemacht?}}

Die Aufgaben 1 und 2 beziehen sich auf zwei Texte aus \emph{M1} und \emph{M2} und operationalisieren schriftliche Einzelarbeitsaufträge in den Aufgabenbereichen II - III durch \emph{erläutern}, \emph{skizzieren} und \emph{erklären}.
...
\begin{quote}
    ...
    \emph{Erläutere} deine Erfahrungen mit Arbeitsschutz in Bezug auf M1 und M2. 
\end{quote}
...
\paragraph{Erwartungshorizont Demokratie A1}
...
Aufgabe 1 bezieht sich auf ein Video, in welchem die Entwicklung des Arbeitsscchutzes in Deutschland beschrieben wird. 
...
In Aufgabe 1 a) wird Abwechlsung durch Partner*innenarbeit geschaffen.
...
Aufgabe 3 a) \emph{M3} ist noch nicht eingefügt. Die Aufgabe zielt aber wieder auf Aufgabenbereich 1 ab. Ein Text wird gelesen und bestimmte Informationen sollen eigenständig wiedergegeben werden. 
Aufgabe 3 b) 

\paragraph{Erwartungshorizont Demokratie A2} 

Aufgabe 1 a) Mögliche Phasen, mindestens fünf: 
\begin{myenumerate}
    \item Einführung (?)
